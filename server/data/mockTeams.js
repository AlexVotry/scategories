const mockTeams = { 
  Blue: [
    { name: "Trudy", email: '', team: 'Blue', admin: false, group: 'family' },
    // { name: "Sam", email: '', team: 'Blue', admin: false, group: 'family' },
  ...
  Green: [
    ...
    { name: "Andy", email: '', team: 'Green', admin: false, group: 'family' },
  ...
  Gold: [
    { name: "Candi", email: '', team: 'Gold', admin: false, group: 'family' },
    { name: "Tim", email: '', team: 'Gold', admin: false, group: 'family' },
    { name: "Xavier", email: '', team: 'Gold', admin: false, group: 'family' }
  ]
};

module.exports = mockTeams;